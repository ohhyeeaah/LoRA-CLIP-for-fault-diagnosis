...
class PU(DatasetBase):

    dataset_dir = 'PU'

    def __init__(self, root, num_shots, working_condition):
        self.dataset_dir = os.path.join(root, self.dataset_dir)
        self.image_dir = os.path.join(self.dataset_dir, 'pu_image/{}'.format(working_condition))
        self.split_path = os.path.join(self.dataset_dir, 'pu_image/{}/split_pu_{}.json'.format(working_condition, working_condition))
