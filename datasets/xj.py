...
class XJ(DatasetBase):

    dataset_dir = 'XJ/Data'

    def __init__(self, root, num_shots, working_condition):
        self.dataset_dir = os.path.join(root, self.dataset_dir)
        self.image_dir = os.path.join(self.dataset_dir, 'xj_image/{}'.format(working_condition))
        self.split_path = os.path.join(self.dataset_dir, 'xj_image/{}/split_xj_{}.json'.format(working_condition, working_condition))
